...
export default async function InformationPage({ searchParams }: Props) {
    ...
    return <div className="p-5">
        <div className="w-full flex gap-2 justify-between">
            ...
            <PdfUploadModal />
            <Link href={"/dashboard/information/add"} className="p-2 border border-primary rounded-lg flex items-center gap-2 bg-primary text-white hover:bg-white hover:text-primary">
                <BiPlus /> Add
            </Link>
        </div>
